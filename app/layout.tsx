...
export const metadata: Metadata = {
  ...
  description:
    "Fullstack developer specialising in web products — multi-role systems, subscription infrastructure, and real-time features. Next.js, Node, Postgres.",
  openGraph: {
    title: "Emmanuel Oghene — Fullstack Developer",
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${dmSerif.variable} ${dmMono.variable} ${inter.variable}`}
    >
